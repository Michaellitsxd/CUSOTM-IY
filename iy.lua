...
Title.TextSize = 18
Title.Text = "Infinite Yield FE v" .. currentVersion .. " custom"
...
CMDs[#CMDs + 1] = {NAME = 'antifling / af', DESC = 'Neutralizes Player Velocity'}
CMDs[#CMDs + 1] = {NAME = 'fly2 / f', DESC = 'R15 custom fly'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Michaellitsxd/CUSOTM-IY/refs/heads/main/iy.lua'))()")
	end
end)
...
addcmd('antifling',{'af'},function(args, speaker)
	notify("Scanning",'Checking for fling exploits')
	loadstring(game:HttpGet(('https://pastebin.com/raw/nMZngqpU'),true))()
    wait(3)
    notify("Success",'Neutralizing velocity')
end)
